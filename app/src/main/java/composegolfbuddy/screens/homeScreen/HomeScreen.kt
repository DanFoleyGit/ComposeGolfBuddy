...
import composegolfbuddy.designsystem.components.ClubInfoRow
import composegolfbuddy.designsystem.components.TextHeader
...
fun HomeScreenInfoContainer(showInformationField: Boolean) {
    ...
    AnimatedVisibility(
        ...
        Column(
            ...
            Text(
                text = "- The app to help you train and improve your game.",
                modifier = Modifier.padding(start = 16.dp)
            )

            TextHeader(textValue = "Home Screen")
            Text(
                text = "- Shows your clubs information you can enter on the \"Clubs\" screen.",
                modifier = Modifier.padding(start = 16.dp)
            )
            ...
            Text(
                text = "- A tool for keeping note of each session and any learning points to reference later. ",
                modifier = Modifier.padding(start = 16.dp)
            )
